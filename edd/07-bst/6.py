...
class BinarySearchTree:
    ...
    def insert(self, key):
        self.root = self._insertRecursively(self.root, key, height=1, parentHasChild=(True, True))

    def _insertRecursively(self, root, key, height, parentHasChild):
        # Redefine height and the levels list.
...
for _ in range(int(input())):
    ...
    print('completo' if tree.singleChilds == 0 else 'no')
